    ...
    def __init__(self, nh1, nc, de, hl=1): #nh2, nc, de):
        ...
        if hl ==2:
            ...
            self.W   = theano.shared(0.2 * numpy.random.uniform(-1.0, 1.0,\
                       (nh1, nc)).astype(theano.config.floatX))
        else:
            self.W   = theano.shared(0.2 * numpy.random.uniform(-1.0, 1.0,\
        ...
        self.score = theano.function(inputs=[x1, x2], outputs=s[0])
